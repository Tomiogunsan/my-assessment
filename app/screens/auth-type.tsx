...
export default function AuthType({ navigation }: IAuthTypeProps ) {
  return (
    <View className="flex-1 bg-[#100a2c]">
      ...
      >
        <View className="flex items-center justify-center pt-[163px]">
          ...
          />
          <Text className="text-[14px] leading-[24px] font-[400] text-white pt-[16px] font-athletics">
        ...
        <View className="flex-1 bg-white mt-[81px] rounded-tr-[50px] rounded-tl-[50px] relative">
          ...
          <View className="pt-[58px] px-[40px]">
            ...
            />
            <Text className="text-[12px] text-[#000]/50 text-center pt-[20px] pb-[10px] font-athletics">
              Already Signed up?
            </Text>
            <Button
              buttonText="Log In"
            ...
            />
            <Text className="text-[10px] text-[#000]/50 text-center pt-[46px] pb-[10px] font-athletics">
