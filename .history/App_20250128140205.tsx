...
export default function App() {
  ...
  const [] = useFonts({
    ...
    "athletics-black": require("./assets/fonts/Athletics Black.woff"),
    "athletics-bold": require("./assets/fonts/Athletics Bold.woff"),
    "athletics-extrabold": require("./assets/fonts/Athletics ExtraBold.woff"),
  })
  return (
