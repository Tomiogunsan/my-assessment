  ...
  return (
    <View className="flex-1 bg-[#100a2c]">
      ...
      >
        ...
        <View className="flex-1 bg-white mt-[81px] rounded-tr-[50px] rounded-tl-[50px] ">
          <View className="flex items-center justify-center pt-[11px] px-[40px]">
          ...
          <Image source={require("../../assets/images/yellowline.png")}
          style={{
            width: '100%',
            height: 56
          }}
