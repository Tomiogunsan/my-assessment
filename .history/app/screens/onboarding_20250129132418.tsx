            ...
            <ImageBackground source={require("../../assets/images/net.png")}>
              <View className="px-[35px]">
                {/* <View className="flex flex-row justify-end items-center">
                  <TouchableOpacity className="rounded-[40px] bg-[#DFEBFA] py-[8px] px-[16px] flex flex-row items-center shadow-black shadow-lg">
      ...
      <AppIntroSlider
        ...
        renderPrevButton={() => (
          <If condition={currentIndex !== 2}>
            <TouchableOpacity className="bg-[#fff] rounded-[48px] py-[17px] px-[30px] absolute bottom-0 right-[-270px] ">
              <Text>Swipe left</Text>
            </TouchableOpacity>
          </If>
        )}
        renderSkipButton={() => (
          <TouchableOpacity className="rounded-[40px] bg-[#DFEBFA] py-[8px] px-[16px] flex flex-row items-center shadow-black shadow-lg absolute  top-[-788px] right-[-370px]">
            <Text className="text-[#212121]">Skip</Text>
            <Feather name="chevrons-right" size={24} color="#414141" />
          </TouchableOpacity>
        )}
