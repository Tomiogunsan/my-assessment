    ...
    return (
      <Switch>
        <Case condition={item.key === 1}>
          <View
            className={`${item.backgroundColor} flex-1   py-[80px] `}
          >
            ...
            <View>
              <Image source={item.image} style={{width: 389, height: 400}} resizeMode="contain"/>
            </View>
          </View>
        </Case>
        <Case condition={item.key === 2}>
          <View className={`${item.backgroundColor} flex-1    relative`}>
            <View className="flex flex-row justify-end items-center px-[35px] pt-[30px]">
              <TouchableOpacity className="rounded-[40px] bg-[#DFEBFA] py-[26px] px-[25px] flex flex-row items-center shadow-black shadow-lg">
                <Text className="text-[#212121]">Skip</Text>
                <Feather name="chevrons-right" size={24} color="#414141" />
              </TouchableOpacity>
            ...
            <Image source={require("../../assets/images/forwardBlueLine.png")} 
            style={{
            width: 143,
            height: 251
            }}
        ...
        <Case condition={item.key === 3}>
          <View className={`${item.backgroundColor} flex-1   `}>
            <View className=" relative w-full ">
              <Image
                source={require("../../assets/images/backwardBlueLine.png")}
                style={{
                  height: 225,
                  width: 138,
                }}
