...
export default function ReferralCode({navigat}) {
  return (
    <View className="flex-1   px-[25px] bg-white pt-[57px]">
      <View className="flex flex-col h-full justify-between items-center ">
        ...
        <View className=" mb-[85px] w-full">
          ...
          <Text className="text-[#1074fd] underline text-center pt-[20px] cursor-pointer" >Skip and continue to Dashboard</Text>
        </View>
      </View>
    </View>
  );
