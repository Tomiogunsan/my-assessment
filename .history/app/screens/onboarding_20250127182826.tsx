    ...
    return (
      <Switch>
        <Case condition={item.key === 1}>
          <View className={`${item.backgroundColor} flex-1   py-4 px-2`}>
            <View className="flex flex-row justify-end items-center">
              <TouchableOpacity className="rounded-[40px] bg-[#DFEBFA] py-[46px] px-[15px] flex flex-row items-center shadow-[#212121] shadow-lg">
