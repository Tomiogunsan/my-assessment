...
const slides = [
  ...
  },
  {
    ...
    text: "Whether you're a full-time pro or part-time, turn your rides, spaces, and community into earnings with CrowdCargo. ",
        ...
        <Case condition={item.key === 3}>
          ...
          >
            ...
            <View className="pt-12">
              ...
              <Text className="text-[18px] font-[400] leading-[24px] text-[#212121] pt-[10px]">
                {item.text}
              </Text>
            </View>
          </View>
